Scheme
{
	...
	Fonts
	{
		...
		"G_FontHuge"
		{
			"1"
			{
				"name"			"SF Pro Display" [$WINDOWS] // Primary font
				"name"			"SF Pro Display" [!$WINDOWS] // Primary font
		...
		"G_FontHuge_2"
		{
			"1"
			{
				"name"			"SF Pro Display" [$WINDOWS] // Secondary font
				"name"			"SF Pro Display" [!$WINDOWS] // Secondary font
		...
		"G_FontHealth"
		{
			"1"
			{
				"name"			"SF Pro Display" [$WINDOWS] // Health Font | Primary font
				"name"			"SF Pro Display" [!$WINDOWS] // Health Font | Primary font
		...
		"G_FontAmmo"
		{
			"1"
			{
				"name"			"SF Pro Display" [$WINDOWS] // Ammo Font | Primary font
				"name"			"SF Pro Display" [!$WINDOWS] // Ammo Font | Primary font
		...
		"G_FontDamage"
		{
			"1"
			{
				"name"			"SF Pro Display" [$WINDOWS] // Damage font | Primary font
				"name"			"SF Pro Display" [!$WINDOWS] // Damage font | Primary font
				"tall"			"20" // Damage size
				"weight"		"0"
				"additive"		"0"
		...
		"G_FontCritDamage"
		{
			"1"
			{
				"name"			"SF Pro Display" [$WINDOWS] // Crit damage font | Primary font
				"name"			"SF Pro Display" [!$WINDOWS] // Crit damage font | Primary font
		...
		"G_FontTargetIDHealth"
		{
			"1"
			{
				"name"			"SF Pro Display" [$WINDOWS] // Target ID health font | Primary font
				"name"			"SF Pro Display" [!$WINDOWS] // Target ID health font | Primary font
		...
		"G_FontKillfeed"
		{
			"1"
			{
				"name"		"SF Pro Display" // Killfeed font
				"tall"		"7" // Killfeed tall
		...
		"CloseCaption_Normal"
		{
			"1"
			{
				"name"		"SF Pro Display" [$WINDOWS] // Closed captions font | Secondary font
				"name"		"SF Pro Display" [!$WINDOWS] // Closed captions font | Secondary font
	...
	CustomFontFiles
	{
		...
		"3"
		{
			"font" "resource/SF Pro Display.ttf"
			"name" "SF Pro Display"
			"russian"
			{
				"range" "0x0000 0xFFFF"
		...
		"4" 
		{
			"font" "resource/SF Pro DisplaySecondary.ttf"
			"name" "SF Pro Display Secondary"
			"russian"
			{
				"range" "0x0000 0xFFFF"
		...
		"5" 
		{
			"font" "resource/SF Pro DisplayProfessor.ttf"
			"name" "SF Pro Display Professor"
			"russian"
			{
				"range" "0x0000 0x00FF"
		...
		"6" 
		{
			"font" "resource/SF Pro DisplayBuild.ttf"
			"name" "SF Pro Display"
			"russian"
			{
				"range" "0x0000 0xFFFF"
