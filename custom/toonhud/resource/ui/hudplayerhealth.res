...
{	
	...
	"HudPlayerHealth"
	{
		...
		"visible"		"1"
		"enabled"		"1"
		"HealthBonusPosAdj"			"50" // Grow size
	...
	"PlayerStatusHealthImage"
	{
		...
		"xpos"			"c-268" // HB xpos
		"ypos"			"r81" // HB ypos
		"xpos_minmode"	"c-248" // HB min xpos
		"ypos_minmode"	"c+57" // HB min ypos
		"zpos"			"4"
		"wide"			"50" // HB size
		"tall"			"50" // HB size
	...
	"PlayerStatusHealthImageBG"
	{
		...
		"xpos"			"c-270" // HB bg xpos
		"ypos"			"r83" // HB bg ypos
		"xpos_minmode"	"c-250" // HB bg min xpos
		"ypos_minmode"	"c+55" // HB bg min ypos
		"zpos"			"3"
		"wide"			"54" // HB bg size
		"tall"			"54"// HB bg size
		"visible"		"0" // HB enabled
